...
@Aspect
public class Logger {
    @Pointcut("execution(* com.example.book_management.controller" +
            ".BookController.borrowBook(..))||execution(* com.example" +
            ".book_management.controller.BookController.returnBook(..))")
    ...
    @Pointcut("execution(* com.example.book_management.controller" +
            ...
            ".book_management.controller.BorrowerController.*(..))")
